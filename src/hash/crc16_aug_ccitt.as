...
package hash
{
    ...
    /**
     * A class to compute the CRC-16/AUG-CCITT checksum of a data stream.
     * 
     * <p>
     * Other names: CRC-16/SPI-FUJITSU
     * </p>
     *
     ...
     * @langversion 3.0
     */
    public final class crc16_aug_ccitt
    {
        ...
        private static var _poly:uint = 0x1021;
        private static var _init:uint = 0x1d0f;
        ...
        /**
         * Creates a CRC-16/AUG-CCITT object. 
         */
        public function crc16_aug_ccitt()
        {
            _length = 0xffff;
        ...
        public function update( bytes:ByteArray, offset:uint = 0, length:uint = 0 ):void
        {
            ...
            {
                c    = uint( bytes[ i ] );
                crc  = 0xffff & ( (crc << 8) ^ lookup[((crc >>> 8) ^ c)] );
            }
